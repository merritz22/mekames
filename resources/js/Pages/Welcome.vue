...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8 font-semibold">
            ...
            <div class="flex">
                <div class="mr-3 p-1 border rounded-lg w-40 text-center  shadow-lg hover:bg-white hover:text-gray-900 transition-all ease-in-out duration-1000">
                    <label>Like</label>
                </div>
                <div class="ml-3 p-1 border rounded-lg w-40 text-center shadow-lg hover:bg-white hover:text-gray-900 transition-all ease-in-out duration-1000">
                    <label>Pricing</label>
                </div>
            </div>
        </div>
    ...
    <div class="block text-center mt-10">
        <h1 class="uppercase font-bold m-5">methodologie chez M<label class="text-red-500 lowercase">e</label>KA</h1>
        <div class="grid grid-cols-2">
            <div class="border">erfe</div>
            <div class="border">erf</div>
            <div class="border">errf</div>
            <div class="border">erf</div>
            <div class="border">rfe</div>
            <div class="border">rfe</div>
        </div>
    </div>
</template>
